...
Seppure il numero delle prove effettuato è basso per ovvi motivi tecnici legati alla preparazione della macchina per ciascuna prova da parte dei tecnici Körber e tenendo conto del prodotto di scarto generato durante le simulazioni (i rotoli di carta prodotti sono stati comunque riciclati), le percentuali di successo sono in linea con quelle previste durante la simulazione in laboratorio effettuata su un numero di prove decisamente maggiore. Anche nel peggiore dei casi il modello è in grado di riconoscere il problema con un massimo di tre tentativi.
