...
## Conclusioni
La prova in azienda è stata realizzata impostando due campagne di misura: la prima per tipologia di guasto finalizzata all'addestramento, la seconda generando stati di guasto random da riconoscere. In pratica il personale tecnico Körber, nella propria postazione a debita distanza da quella degli studenti, ha generato, nella prima campagna, i guasti secondo la sequenza nota della fase di addestramento. Una volta addestrato il modello si è proceduto nella seconda campagna di prove in cui sono stati generati guasti random per il riconoscimento. I risultati, con riferimento al [dataset](https://github.com/looking-for-troubles/L4T/tree/gh-pages/dataset), sono i seguenti:
- il guasto numero 1 è stato riconosciuto dal modello 5 volte su 5 ovvero il 100% di successo;
...
- il guasto numero 3 è stato riconosciuto 4 volte al primo tentativo, 1 volta al secondo tentativo su 5 prove;
