...
Da qui l'idea di realizzare un sistema che potesse essere addestrato anche successivamente dal manutentore in modo da costruire nuovi database dei pesi nel tempo migliorando le predizioni del sistema.
...
<img src="slide/m22.png" width="873" height="375">
...
Nella pagina [Un possibile metodo di addestramento con Crystall Ball di Excel](/mathadd.md) è proposto un metodo di addestramento *a priori* da fare prima della messa in servizio della macchina
